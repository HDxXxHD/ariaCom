   ...
   <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Update Product - {{form.pro_title | upText }} </h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" enctype="multipart/form-data" @submit.prevent="updateProduct()">
                <div class="card-body">
                  ...
                  <div class="form-group">
                      <img :src="updeteImage()" alt="" width="150" >
                  </div>
                </div>
                <!-- /.card-body -->
...
export default {
    ...
    methods:{
        ...
        loadCategories(){
          ...
          updateProduct(){
             this.form.post(`update/${this.$route.params.productid}`)
             .then(()=>{
          ...
          updeteImage(){
              let img = this.form.pro_photo;
              if(img.length > 100){
                  return this.form.pro_photo
              }else{
                  return `img/${this.form.pro_photo}`
              }
          }
